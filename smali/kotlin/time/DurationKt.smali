...
.method public static final synthetic access$skipWhile(Ljava/lang/String;ILkotlin/jvm/functions/Function1;)I
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lkotlin/time/DurationKt;->skipWhile(Ljava/lang/String;ILkotlin/jvm/functions/Function1;)I
...
.method private static final parseDuration(Ljava/lang/String;Z)J
    ...
    invoke-static {v5, v13, v7, v15, v14}, Lkotlin/text/StringsKt;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    .line 1098
    invoke-static {v7, v2}, Lkotlin/time/DurationUnitKt;->durationUnitByIsoChar(CZ)Ljava/util/concurrent/TimeUnit;
    ...
    invoke-virtual {v1, v11}, Ljava/util/concurrent/TimeUnit;->compareTo(Ljava/lang/Enum;)I
    ...
    invoke-static {v14, v15, v7}, Lkotlin/time/DurationKt;->toDuration(JLjava/util/concurrent/TimeUnit;)J
    ...
    invoke-static {v13, v14, v7}, Lkotlin/time/DurationKt;->toDuration(DLjava/util/concurrent/TimeUnit;)J
    ...
    invoke-static {v13, v14, v7}, Lkotlin/time/DurationKt;->toDuration(JLjava/util/concurrent/TimeUnit;)J
    ...
    .line 1135
    invoke-static {v4}, Lkotlin/time/DurationUnitKt;->durationUnitByShortName(Ljava/lang/String;)Ljava/util/concurrent/TimeUnit;
    ...
    invoke-virtual {v14, v11}, Ljava/util/concurrent/TimeUnit;->compareTo(Ljava/lang/Enum;)I
    ...
    invoke-static {v5, v6, v4}, Lkotlin/time/DurationKt;->toDuration(JLjava/util/concurrent/TimeUnit;)J
    ...
    invoke-static {v8, v9, v4}, Lkotlin/time/DurationKt;->toDuration(DLjava/util/concurrent/TimeUnit;)J
...
.method public static final toDuration(ILjava/util/concurrent/TimeUnit;)J
    ...
    invoke-static {v0, v1, p1, p0}, Lkotlin/time/DurationUnitKt;->convertDurationUnitOverflow(JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/TimeUnit;)J
...
.method public static final toDuration(JLjava/util/concurrent/TimeUnit;)J
    ...
    invoke-static {v1, v2, v0, p2}, Lkotlin/time/DurationUnitKt;->convertDurationUnitOverflow(JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/TimeUnit;)J
    ...
    invoke-static {p0, p1, p2, v0}, Lkotlin/time/DurationUnitKt;->convertDurationUnitOverflow(JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/TimeUnit;)J
    ...
    invoke-static {p0, p1, p2, v0}, Lkotlin/time/DurationUnitKt;->convertDurationUnit(JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/TimeUnit;)J
