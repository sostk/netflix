...
.method private showNotification(Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;)V
    ...
    iget-object p1, p1, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lo/onQueueChanged$MediaBrowserCompat;

    .line 4
    invoke-virtual {p1}, Lo/onQueueChanged$MediaBrowserCompat;->IconCompatParcelizer()Landroid/app/Notification;
...
.method private waitForAndApplyImageDownload(Lo/onQueueChanged$MediaBrowserCompat;Lcom/google/firebase/messaging/ImageDownload;)V
    .locals 5
    ...
    .line 2
    invoke-virtual {p1, v1}, Lo/onQueueChanged$MediaBrowserCompat;->read(Landroid/graphics/Bitmap;)Lo/onQueueChanged$MediaBrowserCompat;

    .line 3
    new-instance v2, Lo/onQueueChanged$read;

    invoke-direct {v2}, Lo/onQueueChanged$read;-><init>()V

    invoke-virtual {v2, v1}, Lo/onQueueChanged$read;->write(Landroid/graphics/Bitmap;)Lo/onQueueChanged$read;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lo/onQueueChanged$read;->RemoteActionCompatParcelizer(Landroid/graphics/Bitmap;)Lo/onQueueChanged$read;

    move-result-object v1

    invoke-virtual {p1, v1}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(Lo/onQueueChanged$disconnect;)Lo/onQueueChanged$MediaBrowserCompat;
    :try_end_0
...
.method handleNotification()Z
    ...
    iget-object v3, v2, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lo/onQueueChanged$MediaBrowserCompat;

    .line 5
    invoke-direct {p0, v3, v0}, Lcom/google/firebase/messaging/DisplayNotification;->waitForAndApplyImageDownload(Lo/onQueueChanged$MediaBrowserCompat;Lcom/google/firebase/messaging/ImageDownload;)V
