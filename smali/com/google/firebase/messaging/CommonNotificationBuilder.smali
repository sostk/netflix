...
.method public static createNotificationInfo(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/messaging/NotificationParams;Ljava/lang/String;Landroid/content/res/Resources;Landroid/content/pm/PackageManager;Landroid/os/Bundle;)Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;
    ...
    .line 7
    new-instance v0, Lo/onQueueChanged$MediaBrowserCompat;

    invoke-direct {v0, p0, p3}, Lo/onQueueChanged$MediaBrowserCompat;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 10
    invoke-virtual {v0, p3}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(Ljava/lang/CharSequence;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 13
    invoke-virtual {v0, p3}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(Ljava/lang/CharSequence;)Lo/onQueueChanged$MediaBrowserCompat;

    .line 14
    new-instance v1, Lo/onQueueChanged$write;

    invoke-direct {v1}, Lo/onQueueChanged$write;-><init>()V

    invoke-virtual {v1, p3}, Lo/onQueueChanged$write;->IconCompatParcelizer(Ljava/lang/CharSequence;)Lo/onQueueChanged$write;

    move-result-object p3

    invoke-virtual {v0, p3}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(Lo/onQueueChanged$disconnect;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 17
    invoke-virtual {v0, p3}, Lo/onQueueChanged$MediaBrowserCompat;->IconCompatParcelizer(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 19
    invoke-virtual {v0, p3}, Lo/onQueueChanged$MediaBrowserCompat;->write(Landroid/net/Uri;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, p1}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(Landroid/app/PendingIntent;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 22
    invoke-virtual {v0, p1}, Lo/onQueueChanged$MediaBrowserCompat;->write(Landroid/app/PendingIntent;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->read(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 26
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->IconCompatParcelizer(Z)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 28
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(Z)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 30
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->read(Ljava/lang/CharSequence;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->connect(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->write(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 38
    invoke-virtual {v0, p1}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(Z)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, p3, p4}, Lo/onQueueChanged$MediaBrowserCompat;->read(J)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 41
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer([J)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 43
    invoke-virtual {v0, p4, p1, p0}, Lo/onQueueChanged$MediaBrowserCompat;->read(III)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, p0}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-direct {p0, v0, p1, p3}, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;-><init>(Lo/onQueueChanged$MediaBrowserCompat;Ljava/lang/String;I)V
...
.method private static getColor(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    .line 5
    :try_start_1
    invoke-static {p0, p1}, Lo/onShuffleModeChanged;->IconCompatParcelizer(Landroid/content/Context;I)I
...
.method private static getSmallIcon(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 8
    invoke-static {p1, p4}, Lcom/google/firebase/messaging/CommonNotificationBuilder;->isValidIcon(Landroid/content/res/Resources;I)Z
    ...
    const-string p3, "Couldn\'t get own application info: "
