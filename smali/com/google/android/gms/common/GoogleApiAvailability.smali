...
.method static zaa(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 126
    instance-of v0, p0, Lo/MediaSessionCompat$1;

    if-eqz v0, :cond_0

    .line 128
    check-cast p0, Lo/MediaSessionCompat$1;
    ...
    .line 132
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Lo/onCommand;Ljava/lang/String;)V
...
.method private final zaa(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 154
    new-instance v6, Lo/onQueueChanged$MediaBrowserCompat;

    invoke-direct {v6, p1}, Lo/onQueueChanged$MediaBrowserCompat;-><init>(Landroid/content/Context;)V

    .line 155
    invoke-virtual {v6, v3}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(Z)Lo/onQueueChanged$MediaBrowserCompat;

    move-result-object v6

    .line 156
    invoke-virtual {v6, v3}, Lo/onQueueChanged$MediaBrowserCompat;->IconCompatParcelizer(Z)Lo/onQueueChanged$MediaBrowserCompat;

    move-result-object v6

    .line 157
    invoke-virtual {v6, v0}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(Ljava/lang/CharSequence;)Lo/onQueueChanged$MediaBrowserCompat;

    move-result-object v0

    new-instance v6, Lo/onQueueChanged$write;

    invoke-direct {v6}, Lo/onQueueChanged$write;-><init>()V

    .line 158
    invoke-virtual {v6, v1}, Lo/onQueueChanged$write;->IconCompatParcelizer(Ljava/lang/CharSequence;)Lo/onQueueChanged$write;

    move-result-object v6

    invoke-virtual {v0, v6}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(Lo/onQueueChanged$disconnect;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v0, v1}, Lo/onQueueChanged$MediaBrowserCompat;->IconCompatParcelizer(I)Lo/onQueueChanged$MediaBrowserCompat;

    move-result-object v1

    .line 163
    invoke-virtual {v1, p3}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 167
    invoke-virtual {v0, v1, v4, p4}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Lo/onQueueChanged$MediaBrowserCompat;

    goto :goto_0

    .line 168
    :cond_3
    invoke-virtual {v0, p4}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(Landroid/app/PendingIntent;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 170
    invoke-virtual {v0, v6}, Lo/onQueueChanged$MediaBrowserCompat;->IconCompatParcelizer(I)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v6, v4}, Lo/onQueueChanged$MediaBrowserCompat;->read(Ljava/lang/CharSequence;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    invoke-virtual {v4, v6, v7}, Lo/onQueueChanged$MediaBrowserCompat;->read(J)Lo/onQueueChanged$MediaBrowserCompat;

    move-result-object v4

    .line 173
    invoke-virtual {v4, p4}, Lo/onQueueChanged$MediaBrowserCompat;->RemoteActionCompatParcelizer(Landroid/app/PendingIntent;)Lo/onQueueChanged$MediaBrowserCompat;

    move-result-object p4

    .line 174
    invoke-virtual {p4, v1}, Lo/onQueueChanged$MediaBrowserCompat;->MediaBrowserCompat(Ljava/lang/CharSequence;)Lo/onQueueChanged$MediaBrowserCompat;
    ...
    .line 193
    :cond_7
    invoke-virtual {v0, p4}, Lo/onQueueChanged$MediaBrowserCompat;->write(Ljava/lang/String;)Lo/onQueueChanged$MediaBrowserCompat;

    .line 194
    :cond_8
    invoke-virtual {v0}, Lo/onQueueChanged$MediaBrowserCompat;->IconCompatParcelizer()Landroid/app/Notification;
...
.method public final zaa(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    .line 46
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/google/android/gms/common/GoogleApiAvailability;->zaa(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
