...
.method public static attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V
    ...
    invoke-virtual {v2, v1, v0}, Lo/onPlayFromMediaId;->MediaBrowserCompat(Landroidx/fragment/app/Fragment;Ljava/lang/String;)Lo/onPlayFromMediaId;
    ...
    .line 110
    invoke-virtual {p0}, Lo/onCommand;->MediaBrowserCompat()Z
...
.method public onEventMainThread(Lorg/greenrobot/eventbus/util/ThrowableFailureEvent;)V
    ...
    .line 87
    invoke-virtual {p0}, Lorg/greenrobot/eventbus/util/ErrorDialogManager$SupportManagerFragment;->getFragmentManager()Lo/onCommand;

    move-result-object v0

    .line 88
    invoke-virtual {v0}, Lo/onCommand;->MediaBrowserCompat()Z

    const-string v1, "de.greenrobot.eventbus.error_dialog"

    .line 90
    invoke-virtual {v0, v1}, Lo/onCommand;->findFragmentByTag(Ljava/lang/String;)Landroidx/fragment/app/Fragment;
    ...
    .line 99
    invoke-virtual {p1, v0, v1}, Landroidx/fragment/app/DialogFragment;->show(Lo/onCommand;Ljava/lang/String;)V
