.class Lo/setMeasureWithLargestChildEnabled;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lo/setMeasureWithLargestChildEnabled;->MediaBrowserCompat:Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lo/setMeasureWithLargestChildEnabled;->RemoteActionCompatParcelizer:Landroid/content/ComponentName;

    return-void
.end method

.method static read(Landroidx/work/NetworkType;)I
    .locals 5

    .line 172
    sget-object v0, Lo/setMeasureWithLargestChildEnabled$5;->RemoteActionCompatParcelizer:[I
    ...
    sget-object v3, Lo/setMeasureWithLargestChildEnabled;->MediaBrowserCompat:Ljava/lang/String;
...
.method private static write(Lo/isStacked$RemoteActionCompatParcelizer;)Landroid/app/job/JobInfo$TriggerContentUri;
    .locals 2

    .line 138
    invoke-virtual {p0}, Lo/isStacked$RemoteActionCompatParcelizer;->RemoteActionCompatParcelizer()Z
    ...
    invoke-virtual {p0}, Lo/isStacked$RemoteActionCompatParcelizer;->IconCompatParcelizer()Landroid/net/Uri;
...
.method static write(Landroid/app/job/JobInfo$Builder;Landroidx/work/NetworkType;)V
    .locals 2
    ...
    .line 160
    :cond_0
    invoke-static {p1}, Lo/setMeasureWithLargestChildEnabled;->read(Landroidx/work/NetworkType;)I
...
# virtual methods
.method read(Lo/ensureLogoView;I)Landroid/app/job/JobInfo;
    .locals 9
    ...
    iget-object v3, p0, Lo/setMeasureWithLargestChildEnabled;->RemoteActionCompatParcelizer:Landroid/content/ComponentName;

    invoke-direct {v2, p2, v3}, Landroid/app/job/JobInfo$Builder;-><init>(ILandroid/content/ComponentName;)V

    .line 78
    invoke-virtual {v0}, Lo/setStacked;->getSessionToken()Z
    ...
    invoke-static {p2, v1}, Lo/setMeasureWithLargestChildEnabled;->write(Landroid/app/job/JobInfo$Builder;Landroidx/work/NetworkType;)V
    ...
    .line 86
    iget-object v1, p1, Lo/ensureLogoView;->MediaBrowserCompat:Landroidx/work/BackoffPolicy;

    sget-object v4, Landroidx/work/BackoffPolicy;->read:Landroidx/work/BackoffPolicy;
    ...
    .line 104
    :cond_3
    iget-boolean v1, p1, Lo/ensureLogoView;->write:Z
    ...
    invoke-virtual {v0}, Lo/setStacked;->MediaBrowserCompat()Z
    ...
    .line 111
    invoke-virtual {v0}, Lo/setStacked;->RemoteActionCompatParcelizer()Lo/isStacked;

    move-result-object v1

    .line 112
    invoke-virtual {v1}, Lo/isStacked;->write()Ljava/util/Set;
    ...
    check-cast v4, Lo/isStacked$RemoteActionCompatParcelizer;

    .line 113
    invoke-static {v4}, Lo/setMeasureWithLargestChildEnabled;->write(Lo/isStacked$RemoteActionCompatParcelizer;)Landroid/app/job/JobInfo$TriggerContentUri;
    ...
    .line 115
    :cond_5
    invoke-virtual {v0}, Lo/setStacked;->write()J
    ...
    .line 116
    invoke-virtual {v0}, Lo/setStacked;->read()J
    ...
    iget-boolean p1, p1, Lo/ensureLogoView;->write:Z
